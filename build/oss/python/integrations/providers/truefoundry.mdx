...
You can connect to TrueFoundry's unified LLM gateway through the [`ChatOpenAI`](https://reference.langchain.com/python/langchain-openai/chat-openai) interface.
...
Connect to TrueFoundry by updating the [`ChatOpenAI`](https://reference.langchain.com/python/langchain-openai/chat-openai) model in LangChain:
