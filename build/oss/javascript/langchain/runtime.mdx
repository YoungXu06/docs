...
LangGraph exposes a [`Runtime`](https://reference.langchain.com/javascript/langchain-langgraph/Runtime) object with the following information:

1. **Context**: static information like user id, db connections, or other dependencies for an agent invocation
2. **Store**: a [BaseStore](https://reference.langchain.com/javascript/langchain-langgraph-checkpoint/BaseStore) instance used for [long-term memory](/oss/javascript/langchain/long-term-memory)
...
When creating an agent with `createAgent`, you can specify a `contextSchema` to define the structure of the `context` stored in the agent [`Runtime`](https://reference.langchain.com/javascript/langchain-langgraph/Runtime).
...
Use the `runtime` parameter to access the [`Runtime`](https://reference.langchain.com/javascript/langchain-langgraph/Runtime) object inside a tool.
...
Use the `runtime` parameter to access the [`Runtime`](https://reference.langchain.com/javascript/langchain-langgraph/Runtime) object inside middleware.
