...
This example demonstrates how to setup chat history storage using the `UpstashRedisStore` [`BaseStore`](https://reference.langchain.com/javascript/langchain-langgraph-checkpoint/BaseStore) integration.
