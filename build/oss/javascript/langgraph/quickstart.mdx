...
The agent is built using the [`StateGraph`](https://reference.langchain.com/javascript/langchain-langgraph/StateGraph) class and compiled using the [`compile`](https://reference.langchain.com/javascript/langchain-langgraph/StateGraph) method.
