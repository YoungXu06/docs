...
<Note>
    Deep agents require a model that supports [tool calling](/oss/concepts/tool-calling). See [customization](/oss/deepagents/customization#model) for how to configure your model.
</Note>
