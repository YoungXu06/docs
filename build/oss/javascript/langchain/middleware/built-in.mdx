...
**API reference:** [`toolRetryMiddleware`](https://reference.langchain.com/javascript/langchain/toolRetryMiddleware)
...
**API reference:** [`modelRetryMiddleware`](https://reference.langchain.com/javascript/langchain/modelRetryMiddleware)
...
<ParamField body="edits" type="ContextEdit[]" default="[new ClearToolUsesEdit()]">
    Array of [`ContextEdit`](https://reference.langchain.com/javascript/langchain/ContextEdit) strategies to apply
</ParamField>

**[`ClearToolUsesEdit`](https://reference.langchain.com/javascript/langchain/ClearToolUsesEdit) options:**
