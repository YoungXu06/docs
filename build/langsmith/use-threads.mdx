...
For more information, refer to the [Python](https://reference.langchain.com/python/langgraph-sdk/client/ThreadsClient) and [JS](https://reference.langchain.com/python/langgraph-sdk/client/ThreadsClient) SDK docs, or the [REST API](/langsmith/agent-server-api/threads/create-thread) reference.
...
For more information, refer to the [Python](https://reference.langchain.com/python/langgraph-sdk/client/ThreadsClient) and [JS](https://reference.langchain.com/python/langgraph-sdk/client/ThreadsClient) SDK docs, or the [REST API](/langsmith/agent-server-api/threads/copy-thread) reference.
...
For more information, refer to the [Python](https://reference.langchain.com/python/langgraph-sdk/client/ThreadsClient) and [JS](https://reference.langchain.com/python/langgraph-sdk/client/ThreadsClient) SDK docs, or the [REST API](/langsmith/agent-server-api/threads/search-threads) reference.
...
To view a specific thread given its `thread_id`, use the [`get`](https://reference.langchain.com/python/langgraph-sdk/client/ThreadsClient) method:
...
For more information, refer to the [Python](https://reference.langchain.com/python/langgraph-sdk/client/ThreadsClient) and [JS](https://reference.langchain.com/python/langgraph-sdk/client/ThreadsClient) SDK docs, or the [REST API](/langsmith/agent-server-api/threads/get-thread) reference.

### Inspect thread state

To view the current state of a given thread, use the [`get_state`](https://reference.langchain.com/python/langgraph-sdk/client/ThreadsClient) method. This returns the current values, next nodes to execute, and checkpoint information:
...
For more information, refer to the [Python](https://reference.langchain.com/python/langgraph-sdk/client/ThreadsClient) and [JS](https://reference.langchain.com/python/langgraph-sdk/client/ThreadsClient) SDK docs, or the [REST API](/langsmith/agent-server-api/threads/get-thread-state) reference.
...
To view a thread's history, use the [`get_history`](https://reference.langchain.com/python/langgraph-sdk/client/ThreadsClient) method. This returns a list of every state the thread experienced, allowing you to trace the full execution path:
...
For more information, refer to the [Python](https://reference.langchain.com/python/langgraph-sdk/client/ThreadsClient) and [JS](https://reference.langchain.com/python/langgraph-sdk/client/ThreadsClient) SDK docs, or the [REST API](/langsmith/agent-server-api/threads/get-thread-history) reference.
