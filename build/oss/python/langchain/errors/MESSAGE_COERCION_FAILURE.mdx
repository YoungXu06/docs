...
These include OpenAI style message objects (`{ role: "user", content: "Hello world!" }`), tuples, and plain strings (which are converted to [`HumanMessage`](https://reference.langchain.com/python/langchain/messages/HumanMessage) objects).
