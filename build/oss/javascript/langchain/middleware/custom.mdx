...
Use [`SystemMessage.concat`](https://reference.langchain.com/javascript/langchain-core/messages/SystemMessage) to preserve cache control metadata or structured content blocks created by other middleware.
