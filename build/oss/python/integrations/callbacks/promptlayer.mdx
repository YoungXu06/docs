...
In this simple example we use `PromptLayerCallbackHandler` with [`ChatOpenAI`](https://reference.langchain.com/python/langchain-openai/chat-openai). We add a PromptLayer tag named `chatopenai`
