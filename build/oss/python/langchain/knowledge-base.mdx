...
- By similarity and [maximum marginal relevance](https://reference.langchain.com/python/langchain-core/vectorstores/base/VectorStore) (to balance similarity with query to diversity in retrieved results).
