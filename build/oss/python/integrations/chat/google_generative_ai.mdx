...
<Tip>
    **API Reference**
    ...
    For detailed documentation of all features and configuration options, head to the [`ChatGoogleGenerativeAI`](https://reference.langchain.com/python/langchain-google-genai/chat-google-generative-ai) API reference.
</Tip>
...
See the [`ChatGoogleGenerativeAI`](https://reference.langchain.com/python/langchain-google-genai/chat-google-generative-ai) API Reference for the full set of available model parameters.
...
Provide image inputs along with text using a [`HumanMessage`](https://reference.langchain.com/python/langchain/messages/HumanMessage) with a list content format.
