...
Set `distributed_tracing=True` when initializing [`RemoteGraph`](https://reference.langchain.com/python/langsmith/remote-graph). This automatically propagates trace headers on all requests.
