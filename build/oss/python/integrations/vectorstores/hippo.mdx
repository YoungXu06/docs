...
Below, we create the OpenAI or Azure embedding model using the [`OpenAIEmbeddings`](https://reference.langchain.com/python/langchain-openai/openai-embeddings) method from LangChain.
