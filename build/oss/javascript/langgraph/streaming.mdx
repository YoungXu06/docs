...
LangGraph graphs expose the [`stream`](https://reference.langchain.com/javascript/langchain-langgraph/pregel/Pregel) method to yield streamed outputs as iterators.
