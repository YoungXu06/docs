...
[`OpenAIEmbeddings`](https://reference.langchain.com/python/langchain-openai/openai-embeddings) is assumed, but if you're using Azure OpenAI, import [`AzureOpenAIEmbeddings`](https://reference.langchain.com/python/langchain-openai/azure-openai-embeddings) instead.
...
Create instances of the [`OpenAIEmbeddings`](https://reference.langchain.com/python/langchain-openai/openai-embeddings) and AzureSearch classes. When you complete this step, you should have an empty search index on your Azure AI Search resource. The integration module provides a default schema.
