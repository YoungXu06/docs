...
| Non-agent use with [`bind_tools`](https://reference.langchain.com/python/langchain-anthropic/chat-anthropic) | Tools | Middleware requires [`create_agent`](https://reference.langchain.com/python/langchain/agents/create_agent) |

### Feature comparison

| Feature | Middleware | Tools |
|---------|:----------:|:-----:|
| Works with [`create_agent`](https://reference.langchain.com/python/langchain/agents/create_agent) | ✅ | ✅ |
| Works with [`bind_tools`](https://reference.langchain.com/python/langchain-anthropic/chat-anthropic) | ❌ | ✅ |
...
**API reference:** [`AnthropicPromptCachingMiddleware`](https://reference.langchain.com/python/langchain-anthropic/middleware)
...
**API reference:** [`ClaudeBashToolMiddleware`](https://reference.langchain.com/python/langchain/agents/middleware/ClaudeBashToolMiddleware)
...
`ClaudeBashToolMiddleware` accepts all parameters from [`ShellToolMiddleware`](https://reference.langchain.com/python/langchain/agents/middleware/ShellToolMiddleware), including:
...
**API references:**
- [`StateClaudeTextEditorMiddleware`](https://reference.langchain.com/python/langchain/agents/middleware/StateClaudeTextEditorMiddleware)
- [`FilesystemClaudeTextEditorMiddleware`](https://reference.langchain.com/python/langchain/agents/middleware/FilesystemClaudeTextEditorMiddleware)
...
**[`StateClaudeTextEditorMiddleware`](https://reference.langchain.com/python/langchain/agents/middleware/StateClaudeTextEditorMiddleware) (state-based)**
...
**[`FilesystemClaudeTextEditorMiddleware`](https://reference.langchain.com/python/langchain/agents/middleware/FilesystemClaudeTextEditorMiddleware) (filesystem-based)**
...
**API reference:** [`StateClaudeMemoryMiddleware`](https://reference.langchain.com/python/langchain/agents/middleware/StateClaudeMemoryMiddleware), [`FilesystemClaudeMemoryMiddleware`](https://reference.langchain.com/python/langchain/agents/middleware/FilesystemClaudeMemoryMiddleware)
...
**[`StateClaudeMemoryMiddleware`](https://reference.langchain.com/python/langchain/agents/middleware/StateClaudeMemoryMiddleware) (state-based)**
...
**[`FilesystemClaudeMemoryMiddleware`](https://reference.langchain.com/python/langchain/agents/middleware/FilesystemClaudeMemoryMiddleware) (filesystem-based)**
...
**API reference:** [`StateFileSearchMiddleware`](https://reference.langchain.com/python/langchain/agents/middleware/StateFileSearchMiddleware)
