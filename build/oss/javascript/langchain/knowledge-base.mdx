...
- By similarity and [maximum marginal relevance](https://reference.langchain.com/javascript/langchain-core/vectorstores/VectorStore) (to balance similarity with query to diversity in retrieved results).
