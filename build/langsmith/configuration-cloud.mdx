...
Assistants store _context_ values that customize graph behavior at runtime. You define a context schema in your graph code, then provide specific context values when creating an assistant via the [`context` parameter](https://reference.langchain.com/python/langgraph-sdk/client/AssistantsClient).
...
Use the [AssistantsClient.create](https://reference.langchain.com/python/langgraph-sdk/client/AssistantsClient) method to create a new assistant. This method requires:
...
Use the [AssistantsClient.update](https://reference.langchain.com/python/langgraph-sdk/client/AssistantsClient) method to create a new version of an assistant.
